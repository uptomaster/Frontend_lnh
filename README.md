...
### 📚 과제 및 세션 실습
각 주차 세션 전에
1. 자신의 이름으로 브랜치를(`junhee`) 생성 후
2. 최상위 폴더 안에 자신의 이름으로 폴더 생성('junhee') 하고 그 안에 주차별로 폴더 생성 (week{#n})
3. 세션 실습은 practice 디렉터리에, 과제(강의 실습 코드)는 homework에 각각 작성을 완성하신 뒤에 `main` 브랜치로 PR합니다.
   
### 📤 프로젝트 열기
* 프로젝트를 하나 생성하고 VScode로 열어줍니다.
* VScode 터미널에서 아래를 진행합니다.
