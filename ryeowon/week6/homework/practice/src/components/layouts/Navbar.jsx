...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 border-b border-black left-0 right-0 h-20 bg-gradient-to-r from-[#000428] to-[#004e92] text-white flex items-center justify-between px-10 z-50"> 
      ...
      {accessToken ? (
        <button to="/login" onClick={handleLogout} className="hidden md:block relative after:content-[''] after:absolute after:left-1/2 after:-bottom-1 after:h-[2px] after:w-0 after:bg-gray-400 after:transition-all after:duration-300 after:-translate-x-1/2 hover:after:w-7/8">
        Logout
      </button>
      ) : (
