...
export const FeedAction = ({ likes, onLike }) => {
    ...
    return (
    <div className="flex-none flex flex-col justify-end h-[83px] px-[16px] pb-[13px]">
      <div className="flex flex-row items-center justify-between">
        <div className="flex flex-row gap-[13px]">
          <img src={likeIcon} onClick={onLike} alt="like" className="cursor-pointer w-[22px] h-[22px]" />
      ...
      <div className="pb-[13px] font-bold text-[14px] text-black">좋아요 {likes}개</div>
    </div>
  );
};