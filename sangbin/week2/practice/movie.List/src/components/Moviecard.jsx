const MovieCard = ({ movieImage, title, releaseDate, actor, director, description }) => {
  return (
    <section className="bg-gray-800 p-6 rounded-lg shadow hover:scale-105 transition-transform duration-200">
      <img
        src={movieImage}
        alt={`${title} 영화 포스터`}
