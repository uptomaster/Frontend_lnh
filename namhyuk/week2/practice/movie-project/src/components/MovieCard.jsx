...
const MovieCard = ({ movie, onClick }) => {
  return (
    ...
    <div className="group relative rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 hover:z-10 bg-gray-900 text-white aspect-[2/3] cursor-pointer" onClick={() => onClick(movie)}>
      {/* 포스터 이미지 (기본으로 보이는 부분) */}
