...
const MovieCard = ({ movie, show, onClick }) => {
  ...
  return (
    ...
    <div className="group relative rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:z-10 bg-gray-100 text-white aspect-[2/3] cursor-pointer" onClick={() => onClick && onClick(data)}>
