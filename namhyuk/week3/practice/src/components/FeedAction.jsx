    ...
    <div className="flex-none flex flex-col justify-end h-[83px]">
      <div className="flex flex-row items-center justify-between px-[16px] pb-[13px]">
        <div className="flex flex-row gap-[13px]">
          <img src={likeIcon} alt="like" className="cursor-pointer w-[22px] h-[22px]" onClick={{onLike}}/>
          <img src={commentIcon} alt="comment" className="cursor-pointer w-[22px] h-[22px]" />
          <img src={dmIcon} alt="share" className="cursor-pointer w-[22px] h-[22px]" />
        </div>
