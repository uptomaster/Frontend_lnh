...
const MovieCard = ({ movie }) => {
  ...
  return (
    <section className="w-full bg-gray-800 p-6 rounded-lg shadow-lg hover:scale-105 transition duration-300 cursor-pointer">
      <img
        src={movieImage}
        alt={`${title} 영화 포스터`}
      ...
      <p className="text-gray-200 mt-1 leading-7">📝 설명: {description}</p>
